...
public class QuotationService {
    ...
    public Quotation getQuotation(ParameterIn data) throws QuotationNotFoundException, UrlUnableToInvokeException {
        ...
        if (bdService.isBusinessDay()) {
            try {
                quotation = client.getQuotation(date);
                do {
                ...
                throw new UrlUnableToInvokeException(e.getMessage());
            }
            return quotation;
        } else
